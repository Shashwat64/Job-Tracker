...
authRoutes.post('/signup', async (req, res) => {
    ...
    try {
        ...
        // save user to db
        const result = await pool.query('INSERT INTO users (first_name, last_name, email, username, password_hash) VALUES ($1, $2, $3, $4, $5) RETURNING first_name, last_name, id, email, username, id', [firstName, lastName, email, username, hashedPassword]
